...
This folder contains example data objects from running `cargo test` for the tests in the repository.
...
- [Presentation](./presentation.json) (with 1021 of 1024 `proof` array items removed)
